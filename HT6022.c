...
/**
  ...
  *     Should be called after closing all open devices
  *     (HT6022_DeviceDeinit()) and before your application terminates.
  * @param  None
  * @retval None
  */
...
)
{
  ...
  if ((!IS_HT6022_DATASIZE (DataSize)) || (Device == NULL) ||  (data == NULL))
    return HT6022_ERROR_INVALID_PARAM;
  ...
  *data = HT6022_READ_CONTROL_DATA;
  ...
  if (r != HT6022_SUCCESS || nread != (int)DataSize*2)
  {
...
@verbatim
 ===============================================================================
             ...
             NB: Read seems to corrupt EEPROM and returns variable data
 ===============================================================================
@endverbatim
  * @{
  */
...
/** @defgroup HT6022_Driver_Group4  Sample rate and input voltage range
